defmodule Cuda do
  ...
  * runtime_version - get CUDA runtime version
  ...
  def run(pid, module, func) do
    GenServer.call(pid, {:call, :run, {module, func}}, 10_000)
  end
  def run(pid, module, func, params) do
    GenServer.call(pid, {:call, :run, {module, func, params}}, 10_000)
  end
  def run(pid, module, func, block, params) do
    GenServer.call(pid, {:call, :run, {module, func, block, params}}, 10_000)
  end
  ...
  def run(pid, module, func, block, grid, params) do
    GenServer.call(pid, {:call, :run, {module, func, block, grid, params}}, 10_000)
  end
